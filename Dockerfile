...
RUN curl https://github.com/Manager-io/Manager/releases/download/$(curl --silent "https://api.github.com/repos/Manager-io/Manager/releases/latest" | grep -Po '"tag_name": "\K.*?(?=")')/ManagerServer-linux-x64.tar.gz -o /tmp/manager-server.tar.gz 
